...
class _AboutMeTabletState extends State<AboutMeTablet> {
  ...
  Widget build(BuildContext context) {
    ...
    // double deviceHeight = MediaQuery.of(context).size.height;
    double deviceWidth =
        isdeviceWidth < 872 ? (MediaQuery.of(context).size.width + 190) : 1199;
    // return  NotResp();
    return SingleChildScrollView(
      child: Padding(
        padding:
            const EdgeInsets.only(top: 50, bottom: 100, left: 16, right: 16),
        child: Center(
          child: Column(
                                    ...
                                    children: [
                                      ...
                                      Positioned(
                                        ...
                                        child: rotating_container(
                                          ...
                                          color:
                                              Color(0xFFC0392B), // Lawn Green
                                          rotationZ: 12,
                                          text: "Gym Rat",
                                          emoji:
                                              "assets/emoji/Gym.png", // Weightlifter
                                        ),
                                      ),
                                        Positioned(
                                bottom: 213,
                                  ...
                                  emoji: "assets/emoji/videogame.png", // Weightlifter
                                      ...
                                      Positioned(
                                        ...
                                        child: rotating_container(
                                          ...
                                          color: Color(
                                              0xFFF39C12), // Medium Purple
                                          rotationZ: -4,
                                          text: "Problem Solver",
                                          emoji:
                                              "assets/emoji/Brain.png", // Circle
                                        ),
                                      ),
                                      Positioned(
                                        bottom: 35,
                                        ...
                                        child: rotating_container(
                                          ...
                                          color: Color(
                                              0xFF8E44AD), // Medium Purple
                                          rotationZ: 18,
                                          text: "Friendly Ambivert",
                                          emoji:
                                              "assets/emoji/Moon.png", // Circle
                                        ),
                                      ),
                                    ],
                                  ),
                              ...
                              RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    ...
                                    TextSpan(
                                        text:
                                            ' With a knack for problem-solving and an eye for detail, ',
                                        style: GoogleFonts.chakraPetch(
                                            textStyle: textStyles.P1,
                                            fontSize: kDefaultFontSize)),
                                    TextSpan(
